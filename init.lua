...
-- Column markers to avoid writing too large lines
...
vim.keymap.set('n', '<leader>ll', ':Lazy<cr>', { desc = 'Open [L]azy' })
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      -- jv: I disabled next line in favor of blink.cmp:
      ...
      local servers = {
        ...
        pylsp = {
          settings = {
            pylsp = {
              plugins = { -- ruff do all the stuff these plugins do
      ...
      -- JV: my blink.cmp autocompletion configuration
  ...
  { -- Autoformat
    ...
    enabled = false, -- JV: using a different autoformatter.
    event = { 'BufWritePre' },
    cmd = { 'ConformInfo' },
    keys = {
      {
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'css', 'typescript', 'javascript', 'python', 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
